      ...
      <div className="background-blur" onClick={onClose}>
        <div className="course-selector" style={{ maxWidth: '700px' }} onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex flex-col items-center justify-center py-12 gap-4">
                ...
                className="profile-button-like profile-button-gold bg-gradient-to-r from-[var(--color-purdue-gold)] to-[var(--color-purdue-rush)] text-black font-semibold text-sm rounded-lg hover:opacity-90 transition-opacity"
                >
            ...
            <div className="flex flex-col gap-4">
                ...
                className="profile-button-like profile-button-blue bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center gap-2"
                >
                ...
                <button
                onClick={handleGenerateStudyGuide}
                className="profile-button-like profile-button-gray bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors"
                >
                ↻ Regenerate
                </button>
                </div>
