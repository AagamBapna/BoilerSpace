    ...
    <div className="flex h-screen w-screen overflow-hidden relative">
      ...
      <div className="fixed top-4 right-4 z-40 flex flex-col items-end gap-2 pointer-events-none">
        ...
        <div className="flex items-center gap-2 pointer-events-auto">
          ...
          <button onClick={() => setNavExpanded(!navExpanded)} className="h-10 px-3 bg-[var(--color-surface-light)] border border-[var(--color-purdue-gold)]/20 rounded-xl shadow-lg flex items-center gap-2 text-sm font-medium hover:bg-[var(--color-surface-hover)] transition-colors text-[var(--color-text-primary)]">
          ...
          <button onClick={() => setShowProfile(true)} className="h-10 px-3 bg-[var(--color-surface-light)] border border-[var(--color-purdue-gold)]/20 rounded-xl shadow-lg flex items-center gap-2 text-sm font-medium hover:bg-[var(--color-surface-hover)] transition-colors text-[var(--color-text-primary)]">
        ...
        {navExpanded && (
          <div className="bg-[var(--color-surface-light)] border border-white/10 rounded-xl shadow-2xl p-2 flex flex-col gap-1 w-56 pointer-events-auto max-h-[70vh] overflow-y-auto animate-dropdownIn">
            ...
            <button onClick={() => { axios.get(`/api/users/${user.id}/courses`).then(res => { setUserCourses(res.data); setNotesView({ step: 'pick' }); setNavExpanded(false); }).catch(() => setUserCourses([])); }} className="w-full text-left px-3 py-2 text-sm font-medium text-[var(--color-text-primary)] hover:bg-[var(--color-surface-hover)] rounded-lg transition-colors flex items-center gap-2">
              Course Notes
            </button>
            <button onClick={() => { setShowStudyPlan(true); setNavExpanded(false); }} className="w-full text-left px-3 py-2 text-sm font-medium text-[var(--color-text-primary)] hover:bg-[var(--color-surface-hover)] rounded-lg transition-colors flex items-center gap-2">
              Study Plan
            </button>

            <div className="h-px w-full bg-white/10 my-1"/>

            <button onClick={() => { setShowDM(true); setNavExpanded(false); }} className="w-full text-left px-3 py-2 text-sm font-medium text-[var(--color-text-primary)] hover:bg-[var(--color-surface-hover)] rounded-lg transition-colors flex items-center gap-2">
              Messages
            </button>
            <button onClick={() => { setShowSearch(true); setNavExpanded(false); }} className="w-full text-left px-3 py-2 text-sm font-medium text-[var(--color-text-primary)] hover:bg-[var(--color-surface-hover)] rounded-lg transition-colors flex items-center gap-2">
              Find Match
            </button>
            <button onClick={() => { setShowClassmates(true); setNavExpanded(false); }} className="w-full text-left px-3 py-2 text-sm font-medium text-[var(--color-text-primary)] hover:bg-[var(--color-surface-hover)] rounded-lg transition-colors flex items-center gap-2">
              Classmates
            </button>
            <button onClick={() => { setShowFriendsList(true); setNavExpanded(false); }} className="w-full text-left px-3 py-2 text-sm font-medium text-[var(--color-text-primary)] hover:bg-[var(--color-surface-hover)] rounded-lg transition-colors flex items-center gap-2">
              Friends
            </button>
            <button onClick={() => { setShowFriendRequests(true); setNavExpanded(false); }} className="w-full text-left px-3 py-2 text-sm font-medium text-[var(--color-text-primary)] hover:bg-[var(--color-surface-hover)] rounded-lg transition-colors flex items-center gap-2 relative">
              Requests
