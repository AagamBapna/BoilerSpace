...
const roomsData = {
    EE: [
        { name: 'EE 117', floor: 1, capacity: 200, amenities: ['Projector', 'Outlets'], noiseClassification: 'Collaborative' },
        { name: 'EE 207', floor: 2, capacity: 40, amenities: ['Outlets', 'Whiteboard'], noiseClassification: 'Moderate' },
        { name: 'EE 309', floor: 3, capacity: 25, amenities: ['Whiteboard'], noiseClassification: 'Quiet' },
    ],
    HAMP: [
        { name: 'HAMP 1231', floor: 1, capacity: 60, amenities: ['Projector'], noiseClassification: 'Moderate' },
        { name: 'HAMP 2201', floor: 2, capacity: 25, amenities: ['Outlets', 'Whiteboard'], noiseClassification: 'Quiet' },
    ],
    HEAV: [
        { name: 'HEAV 226', floor: 2, capacity: 35, amenities: ['Projector'], noiseClassification: 'Moderate' },
        { name: 'HEAV 331', floor: 3, capacity: 25, amenities: ['Whiteboard'], noiseClassification: 'Quiet' },
    ],
    HIKS: [
        { name: 'HIKS Study Room A', floor: 1, capacity: 8, amenities: ['Whiteboard'], noiseClassification: 'Quiet' },
        { name: 'HIKS Study Room B', floor: 1, capacity: 8, amenities: ['Whiteboard'], noiseClassification: 'Quiet' },
        { name: 'HIKS Open Area', floor: 2, capacity: 100, amenities: ['Outlets', 'Printers'], noiseClassification: 'Moderate' },
    ],
    KRAN: [
        { name: 'KRAN G001', floor: 0, capacity: 80, amenities: ['Projector', 'Outlets'], noiseClassification: 'Collaborative' },
        { name: 'KRAN 105', floor: 1, capacity: 35, amenities: ['Whiteboard', 'Outlets'], noiseClassification: 'Moderate' },
    ],
    LWSN: [
        { name: 'LWSN B134', floor: 0, capacity: 200, amenities: ['Projector', 'Outlets'], noiseClassification: 'Collaborative' },
        { name: 'LWSN 1106', floor: 1, capacity: 45, amenities: ['Whiteboard', 'Outlets'], noiseClassification: 'Moderate' },
        { name: 'LWSN 3102', floor: 3, capacity: 30, amenities: ['Outlets', 'Whiteboard'], noiseClassification: 'Quiet' },
    ],
    LILY: [
        { name: 'LILY 1105', floor: 1, capacity: 80, amenities: ['Projector', 'Outlets'], noiseClassification: 'Collaborative' },
        { name: 'LILY 2102', floor: 2, capacity: 40, amenities: ['Whiteboard', 'Outlets'], noiseClassification: 'Moderate' },
    ],
    MATH: [
        { name: 'MATH 175', floor: 1, capacity: 120, amenities: ['Projector'], noiseLevel: 'loud' },
        { name: 'MATH 211', floor: 2, capacity: 30, amenities: ['Whiteboard', 'Outlets'], noiseClassification: 'Moderate' },
    ],
    STEW: [
        { name: 'STEW 214', floor: 2, capacity: 50, amenities: ['Projector', 'Outlets'], noiseClassification: 'Moderate' },
        { name: 'STEW Lounge', floor: 1, capacity: 30, amenities: ['Outlets', 'Cafe'], noiseClassification: 'Moderate' },
    ],
    WALC: [
        { name: 'WALC 1018', floor: 1, capacity: 30, amenities: ['Whiteboard', 'Projector'], noiseClassification: 'Moderate' },
        { name: 'WALC 1055', floor: 1, capacity: 20, amenities: ['Outlets', 'Whiteboard'], noiseClassification: 'Quiet' },
        { name: 'WALC 2051', floor: 2, capacity: 50, amenities: ['Projector', 'Outlets', 'Whiteboard'], noiseClassification: 'Moderate' },
        { name: 'WALC 3087', floor: 3, capacity: 40, amenities: ['Whiteboard', 'Projector', 'Outlets'], noiseClassification: 'Collaborative' },
    ],
    DUDL: [
        { name: 'DUDL 1119', floor: 1, capacity: 30, amenities: ['Whiteboard', 'Projector'], noiseClassification: 'Moderate' },
        { name: 'DUDL 1383', floor: 1, capacity: 30, amenities: ['Lab'], noiseClassification: 'Quiet' },
        { name: 'DUDL 1389 (Trimple Technology Lab)', floor: 1, capacity: 50, amenities: ['Surveying Equipment'], noiseClassification: 'Moderate' },
        { name: 'DUDL 4331', floor: 4, capacity: 40, amenities: ['Whiteboard', 'Projector', 'Outlets'], noiseClassification: 'Moderate' },
    ],
    DSAI: [
        { name: 'DSAI 1004', floor: 1, capacity: 30, amenities: ['Whiteboard', 'Projector', 'Outlets'], noiseClassification: 'Moderate' },
        { name: 'DSAI 1069', floor: 1, capacity: 30, amenities: ['Whiteboard', 'Projector', 'Outlets'], noiseClassification: 'Moderate' },
        { name: 'DSAI 2041', floor: 2, capacity: 30, amenities: ['Whiteboard', 'Projector', 'Outlets'], noiseClassification: 'Moderate' },
        { name: 'DSAI 2105', floor: 2, capacity: 30, amenities: ['Whiteboard', 'Projector', 'Outlets'], noiseClassification: 'Moderate' },
    ],
    ARMS: [
